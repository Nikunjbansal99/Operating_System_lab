...
void main()
{
      ...
      printf("\nProcess Name\tPriority\tArrival Time\tBurst Time\tCompletion Time\tWaiting Time\tTurn Around Time");
      for(time = process_queue[0].arrival_time; time < burst_time;)
      {
            ...
            printf("\n%c\t\t%d\t\t%d\t\t%d\t\t%d\t\t%d\t\t%d", process_queue[largest].process_name, process_queue[largest].priority, process_queue[largest].arrival_time, process_queue[largest].burst_time, process_queue[largest].ct,
                   process_queue[largest].waiting_time, process_queue[largest].turnaround_time);
      }
